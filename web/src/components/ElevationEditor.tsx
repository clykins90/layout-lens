            ...
            <DialogContent className="max-w-[95vw] w-[95vw] h-[90vh] flex flex-col p-0 gap-0 overflow-hidden">
                <DialogHeader className="p-4 border-b shrink-0">
                    <div className="flex justify-between items-center">
                        <div>
                            <DialogTitle>Elevation View</DialogTitle>
                ...
                <div className="flex flex-1 min-h-0 overflow-hidden">
                    {/* Toolbar */}
                    <div className="w-24 shrink-0 bg-muted/30 border-r flex flex-col items-center py-6 z-10 overflow-y-auto">
                        <ToggleGroup
                            type="single"
                            value={tool}
                        ...
                        >
                            {TOOLS.map((t) => (
                                <ToggleGroupItem
                                    key={t.id}
                                    value={t.id}
                                    className="flex flex-col items-center gap-1 h-auto py-2 px-3 w-18 data-[state=on]:bg-primary/10 data-[state=on]:text-primary"
                                >
                    ...
                    {/* Properties Sidebar */}
                    <div className="w-64 shrink-0 bg-background border-l p-4 overflow-y-auto">
                        {renderProperties()}
                    </div>
                </div>
            </DialogContent>
